...
public class Kata {
	...
	public int next_delimiter_position( String numbers, String delimiter){
		...
		while ( index<numbers.length() &&
				numbers.charAt(index) != delimiter.charAt(0) && 
	...
	public String List_Negatives(String numbers, String delimiter){
		...
		if (numbers.charAt(0) == '\n'){
			return List_Negatives(numbers.substring(1), delimiter);
		}
		...
		delimiter_position = next_delimiter_position(numbers, delimiter);
